...
\tablehead{\colhead{Planets} & \colhead{c} & \colhead{d} & \colhead{b} & \colhead{e} \\
\hline\
P [days]               &  &  &  &  \\
$T_0$ [BJD - 2457000]  &  &  &  &  \\
Depth [ppt]            &  &  &  &  \\
...
\begin{figure}[!ht]
\begin{center}
\includegraphics[width=0.465\textwidth,trim={0.25cm 0 4.5cm 0}]{folded_compare.pdf}
\caption{Phase-folded transits comparing the transit depth observed with \textit{K2} (gray) and \tess\ (color) with residuals from the best-fit model (solid line) underneath. Gaps in the data are due to other planets' transits being masked. \label{fig:compare}}
\end{center}
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\fi
