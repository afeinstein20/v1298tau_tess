...
\begin{figure}[!ht]
\begin{center}
\includegraphics[width=0.465\textwidth,trim={0.25cm 0 6.5cm 0}]{figures/folded_compare.pdf}
...
\hline
$T_0$ [BKJD - 2454833]  & $4648.1576_{-0.0036}^{+0.004}$ & $4645.4158_{-0.0028}^{+0.0024}$ & $4648.0927_{-0.0017}^{+0.0015}$ & $4648.8002_{-0.0014}^{+0.0014}$ \\
