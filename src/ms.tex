...
\begin{figure*}[hbtp]
\begin{center}
\includegraphics[width=0.7\textwidth,trim={0.25cm 0 0 0}]{figures/transits.pdf}
...
\begin{figure}[h]
\begin{center}
\includegraphics[width=0.44\textwidth,trim={0.25cm 0 0cm 0}]{figures/periode.pdf}
